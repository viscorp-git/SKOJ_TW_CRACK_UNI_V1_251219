...
namespace IDMAX_FrameWork
{
	...
	public class FlatToggle : Control
	{
        ...
        //public Color BaseColorRed1 { get => BaseColorRed; set => BaseColorRed = value; }
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			switch (O)
			{
				...
				case _Options.Style2:
					...
					//_with9.FillPath(new SolidBrush(BaseColorRed1), GP);
					_with9.FillPath(new SolidBrush(ToggleColor), GP2);
				...
				case _Options.Style3:
					...
					_with9.FillPath(new SolidBrush(ToggleColor), GP);
					//_with9.FillPath(new SolidBrush(BaseColorRed1), GP2);

					//-- Text
					//_with9.DrawString("OFF", Font, new SolidBrush(BaseColorRed1), new Rectangle(-12, 2, W, H), Helpers.CenterSF);
