...
namespace IDMAX_FrameWork
{
    public class MaterialListView : ListView, IMaterialControl
    {
        ...
        public MaterialListView()
        {
            ...
            MouseState = MouseActiveState.OUT;
            MouseEnter += delegate
            {
                MouseState = MouseActiveState.HOVER;
            };
            MouseLeave += delegate
            {
                MouseState = MouseActiveState.OUT;
            ...
            MouseDown += delegate { MouseState = MouseActiveState.DOWN; };
            MouseUp += delegate { MouseState = MouseActiveState.HOVER; };
        ...
        protected override void OnDrawItem(DrawListViewItemEventArgs e)
        {
            ...
            else if (e.Bounds.Contains(MouseLocation) && MouseState == MouseActiveState.HOVER)
            {
                //hover background
        ...
        protected override void OnCreateControl()
        {
            ...
            // This hack tries to apply the Roboto Condensed (24) font to all ListViewItems in this ListView
