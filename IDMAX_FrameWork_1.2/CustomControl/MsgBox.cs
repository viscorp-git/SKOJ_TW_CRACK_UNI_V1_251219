...
namespace IDMAX_FrameWork
{
    public class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            _lblTitle.Font = new System.Drawing.Font("맑은 고딕", 20);
            _lblTitle.Dock = DockStyle.Top;
            _lblTitle.Height = 50;

            _lblMessage = new Label();
            _lblMessage.ForeColor = Color.White;
            _lblMessage.Font = new System.Drawing.Font("맑은 고딕", 15);
        ...
        public static DialogResult Show(string message, string title, Buttons buttons, Icon icon, AnimateStyle style,Color color)
        {
            _msgBox = new MsgBox();
            _msgBox._lblMessage.Text = message;
            _msgBox._lblTitle.Text = title;
            _msgBox.Height = 0;
            _msgBox.BackColor = color;
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            foreach (Button btn in _msgBox._buttonCollection)
            {
                ...
                btn.Font = new System.Drawing.Font("맑은 고딕", 15);
        ...
        private static Size MessageSize(string message)
        {
            ...
            SizeF size = g.MeasureString(message, new System.Drawing.Font("Segoe UI", 15));

            if (message.Length < 150)
            {
                if ((int)size.Width > 400)
                {
