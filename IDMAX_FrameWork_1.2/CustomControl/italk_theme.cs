...
using IDMAX_FrameWork.Properties;
using System.Linq;
...
namespace IDMAX_FrameWork
{
    ...
    public class iTalk_ThemeContainer : ContainerControl
    {
        ...
        public iTalk_ThemeContainer()
        {
            ...
            //Dock = DockStyle.Fill;
            MoveHeight = 25;
            Padding = new Padding(1, 23, 1, 1);
            Font = new Font(LoadFont(Resources.Roboto_Medium), 10f);
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(246, 246, 246)), RoundRectangle.RoundRect(new Rectangle(2, 20, Width - 5, Height - 25), BorderCurve));
            ...
            G.DrawString(Text.ToUpper(), new Font(LoadFont(Resources.Roboto_Regular), 10f), new SolidBrush(Color.FromArgb(221, 221, 221)), new Rectangle(BorderCurve+5, BorderCurve , Width - 5, 22), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Center });
           ...
           // G.DrawLine(new Pen(Color.FromArgb(52, 52, 52)), 7, Height - 4, Width - 7, Height - 4);
            ...
            //G.DrawString(_TextBottom, new Font("Tahoma", 10, FontStyle.Bold), new SolidBrush(Color.FromArgb(221, 221, 221)), 5, Height - 23);
    ...
    public class iTalk_Button_2 : Control
    {
        ...
        public iTalk_Button_2()
        {
            ...
            Size = new Size(166, 40);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(210, 210, 210));
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(131, 131, 131), Color.FromArgb(151, 151, 151), 90f);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(100, 100, 100), Color.FromArgb(90, 90, 90), 90f);
                PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(80, 80, 80), Color.FromArgb(80, 80, 80), 90f);
                    ...
                    case iTalk_Toggle._Type.YesNo:
                        {
                            ...
                            if (toggled)
                            {
                                G.DrawString("Yes", new Font("Tahoma", 10f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 7), (float)this.Bar.Y, new StringFormat
                                {
                            ...
                            {
                                G.DrawString("No", new Font("Tahoma", 10f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 18), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
                    ...
                    case iTalk_Toggle._Type.OnOff:
                        {
                            ...
                            if (toggled)
                            {
                                G.DrawString("On", new Font("Tahoma", 10f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 7), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
                            ...
                            {
                                G.DrawString("Off", new Font("Tahoma", 10f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 18), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
                    ...
                    case iTalk_Toggle._Type.IO:
                        {
                            ...
                            if (toggled)
                            {
                                G.DrawString("I", new Font("Tahoma", 10f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 7), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
                            ...
                            {
                                G.DrawString("O", new Font("Tahoma", 10f, FontStyle.Regular), Brushes.Gray, (float)(this.Bar.X + 18), (float)this.Bar.Y, new StringFormat
                                {
                                    Alignment = StringAlignment.Center,
                                    LineAlignment = StringAlignment.Center
                                });
    ...
    public  class iTalk_HeaderLabel : Label
    {
        ...
        {
            Font = new Font("tahoma", 25, FontStyle.Regular);
    ...
    public class iTalk_TextBox_Big : Control
    {
        ...
        protected void _OnKeyDown(object Obj, KeyEventArgs e)
        {
    ...
    public  class iTalk_NotificationNumber : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _G.DrawString(myString, new Font("tahoma", 8, FontStyle.Bold), new SolidBrush(Color.FromArgb(255, 255, 253)), new Rectangle(0, 0, Width - 2, Height), new StringFormat
            {
                Alignment = StringAlignment.Center,
                LineAlignment = StringAlignment.Center
            });
   ...
   public class iTalk_ComboBox : ComboBox
    ...
    public class iTalk_Icon_Info : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("¡", new Font("tahoma", 25, FontStyle.Bold), new SolidBrush(Color.Gray), new Rectangle(4, -14, Width, 43), new StringFormat
            {
                Alignment = StringAlignment.Near,
